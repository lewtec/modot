...
- Library import path is `pkg/` (`api`, `driver`, `filespine`, `logging`, `palette`); the rest is `internal/` + `cmd/`. Task pools are `github.com/lewtec/lewkit/x/taskgroup`. Details in AGENTS.md.
