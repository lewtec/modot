...
Drivers are the imperative face of modot: do this on the machine now.
Volume, brightness, workspaces/WM, screenshots, wallpaper, notifications,
openers, power, camera, etc. live under `modot driver …` (and sometimes
...
Driver weights and preferences can appear in `modot.cue` (evaluated
