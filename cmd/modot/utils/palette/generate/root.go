...
import (
	...
	"github.com/lewtec/modot/internal/palette"
...
Drivers (see also: modot utils palette drivers):
`)
...
Examples:
  ...
  modot utils palette generate ~/wallpaper.jpg --polarity dark

  # Material You scheme as base24
  modot utils palette generate image.png --driver materialyou --colors 24 --polarity light`)
	return b.String()
}
