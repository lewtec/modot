...
func (iconOutput) ArgDefault() string {
	return envdriver.ExpandPath("~/.local/share/icons/modot-base16")
}
...
type Generate struct {
	...
	ThemeName      cmd.StringArg   `long:"theme-name" help:"Theme name written in index.theme" default:"modot-base16"`
...
Template variables include base16 keys (base00..base0F) from the active modot config.
