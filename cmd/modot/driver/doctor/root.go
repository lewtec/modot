...
type Command struct {
	Verbose cmd.Flag `short:"v" long:"verbose" help:"Show full interface and driver names"`
}

func (Command) Description() string {
	return "Check status of all registered drivers"
}
...
func getFriendlyInterfaceName(fullPath string) string {
	...
	// e.g., "github.com/lewtec/modot/internal/driver/audio.Driver" -> "audio.Driver"
	// or   "github.com/lewtec/modot/internal/driver/dialog.Chooser" -> "dialog.Chooser"
	...
	// e.g., "github.com/lewtec/modot/internal/driver/audio.Driver" -> "audio"
