...
func (Cpu10k) Description() string {
	return `Map.Run dispatches 10k × ~100ms CPU items; Control bar tracks children

taskgroup.Map.Run schedules one Control orchestrator (aggregate N/10000 progress)
