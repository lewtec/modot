...
func GetLogger(ctx context.Context) *slog.Logger {
	...
	panic("no logger present in context; call ContextWithLogger on a root ctx before any GetLogger / ReportError / Close / RunCleanup etc. See cmd/modot/root.go for bootstrap pattern.")
}
